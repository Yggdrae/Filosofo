...
mtg = ["Rakdos", "Selesnya", "Izzet", "Dimir"]
mtg.append("Gruul") #adiciona um item a ultima posição da lista
mtg.append("Orzhov")

print(mtg)
print(str(len(mtg)))

#mtg.remove("Orzhov") #remove o item especificado
#mtg.pop() #remove o ultimo item da lista
#del mtg[1] #remove um item via indice
#mtg.clear() #limpa totalmente a lista

mtg2 = ["Simic", "Boros", "Azorius", "Golgari"]
print(mtg2)
print(str(len(mtg2)))
